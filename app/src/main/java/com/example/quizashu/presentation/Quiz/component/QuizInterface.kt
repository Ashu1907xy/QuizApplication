...
import com.example.quizashu.presentation.Quiz.QuizState
...
fun QuizInterface(
    ...
    val question : String = quizState.quiz?.question!!.replace("&quot;" , "\"").replace("&#039;" , "\"")
                    ...
                    options.forEachIndexed { indix, (optionNumber, optionText) ->
                        if (optionText.isNotEmpty()) {
                            QuizOption(
                                ...
                                options = optionText,
                                onOptionClick = { onOptionSelected(indix) },
                                selected = quizState.selectedOptions == indix,
